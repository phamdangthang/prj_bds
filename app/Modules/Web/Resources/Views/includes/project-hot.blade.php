<div class="slider-project-hot">
    @foreach ($projectHot as $item)
        ...
        <div class="news-slider-project-hot">
            ...
            <div class="text-eclipse" style="max-height: 60px">{!! $item->description !!}</div>
        </div>
    @endforeach
</div>
...
@foreach ($projectHot as $item)
    ...
    <div class="row row0 project-hot">
        ...
        <div class="col-lg-7 col-md-7 col-sm-7 col-7 pad10">
            ...
            <div class="text-eclipse" style="max-height: 56px; max-width: 130px; white-space: break-spaces;">{!! $item->description !!}</div>
        </div>
    </div>
@endforeach
