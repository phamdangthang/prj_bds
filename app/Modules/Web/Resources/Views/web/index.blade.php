	...
	<div class="container news-latest">
		<div class="row">
			<div class="col-lg-9 col-md-12 col-sm-12 col-12">
				<div class="cate">
					<h1 class="title-cate">TIN MỚI NHẤT</h1>
					<form action="#">
				...
				<div class="new new-hot">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-4">
							<a href="" class="c-img hv-light"><img src="{{ asset('images/tintuc-1.jpg') }}" alt=""></a>
						</div>
						<div class="col-lg-8 col-md-8 col-sm-8 col-8 info-new">
							<h4><a href="">Căn hộ chung cư căn hộ FLC Đại Mỗ, căn 05 tòa HH3, DT 66m2 , 17,5 triệu/m2 . LH 0981129026</a></h4>
							<span class="date-submitted">Ngày đăng : <span>11/12/2018</span></span>
							<span class="price">Giá: <span>17.5 Triệu/m²</span></span>
							<span class="badroom">Phòng ngủ : <span>2</span></span>
							<span class="acreage">Diện tích: <span>88 m²</span></span>
							<span class="door-direction">Hướng cửa : <span>Nam</span></span>
							<span class="project">Dự án : <span>An Bình City</span></span>
							<span class="balcony">Ban công : <span>Bắc</span></span>
						</div>
						<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="location d-flex justify-content-around">
								<span class="court">Tòa: <span>A1</span></span>
								<span class="floor">Tầng:  <span>2</span></span>
								<span class="apartment-number">Căn hộ số: <span>06</span></span>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-12 col-sm-12 col-12 index-right">
				...
				<div class="order-product">
					...
					<form action="#">
						<p>Wikihouse.vn sẽ tìm sản phẩm theo yêu cầu của bạn trong thời gian sớm nhất :</p>
						<input type="text" placeholder="Họ và tên">
						<input type="email" placeholder="Email">
						<input type="text" placeholder="Số điện thoại">
						<textarea name="" id="" rows="4" placeholder="Yêu cầu"></textarea>
						<button class="order-now">ĐẶT HÀNG NGÀY</button>
					</form>
				</div>
				<div class="area">
					<h3 class="title-index-right">BÁN CĂN HỘ TẠI HÀ NỘI</h3>
					<ul>
						<li><a href="">Ba Đình <span>(2278)</span></a></li>
						<li><a href="">Ba Đình <span>(2278)</span></a></li>
						<li><a href="">Ba Đình <span>(2278)</span></a></li>
						<li><a href="">Ba Đình <span>(2278)</span></a></li>
						<li><a href="">Ba Đình <span>(2278)</span></a></li>
				...
				<div class="news-highlight">
					...
					<div class="row row0 new-highlight">
						<div class="col-lg-5 col-md-5 col-sm-5 col-5 pad0">
							<a href="" class="c-img"><img src="{{ asset('images/tinnoibat.jpg') }}" alt=""></a>
						</div>
						<div class="col-lg-7 col-md-7 col-sm-7 col-7 pad-l-10">
							<p><a href="">Căn hộ chung cư FLC Đại Mỗ 66m2. Giá : 3,5 tỉ</a></p>
